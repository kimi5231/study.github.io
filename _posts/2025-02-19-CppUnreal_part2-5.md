---
title: "[C++과 언리얼로 만드는 MMOPRG 게임 개발 시리즈 Part2] Root Signature"
date: 2025-02-19
categories:
...
{% capture notice-1 %}
* DescriptorHeap을 초기화하고 관리하는 클래스
{% endcapture %}

#### EnginePch에 CBV_REGISTER enum class 추가 및 개수를 나타내는 enum에 CBV_REGISTER_COUNT, REGISTER_COUNT 추가
...
#### RootSignature Init 함수에 DescriptorTable 추가
...
#### ConstantBuffer 클래스에 DescriptorHeap 생성에 관한 코드 추가
...
#### Engine 클래스에 TableDescriptorHeap 추가
...
#### CommandQueue RenderBegin 함수에 TableDescriptorHeap 초기화 및 어떤 DescriptorHeap을 사용할 것인지 지정하는 코드 추가
...
#### ConstantBuffer PushData 함수 TableDescriptorHeap에 맞춰 수정
...
#### 변경된 PushData 함수에 맞춰 Mesh Render 함수도 수정
